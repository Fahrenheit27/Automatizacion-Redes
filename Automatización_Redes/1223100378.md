...
## ⚙️ Automatización de Infraestructura Digital I
...
1. [⚡ Actividad 1](#actividad-1)
   ...
   - [🔧 Desarrollo](#desarrollo)
     - [🛠️ Descripción de las herramientas utilizadas para automatización](#descripción-de-las-herramientas-utilizadas-para-automatización)
       - [🐳 Docker Engine](#docker-engine)
       - [🐙 Docker Compose](#docker-compose)
       - [📡 Docker Swagger](#docker-swagger)
     - [💾 Procedimiento de instalación](#procedimiento-de-instalación)
       - [🖥️ Instalación técnica de herramientas necesarias](#instalación-técnica-de-herramientas-necesarias-vscode-plugins-etc)
...
### 🛠️ Descripción de las herramientas utilizadas para automatización:
...
#### 🖥️ Instalación técnica de herramientas necesarias (VSCode, Plugins, etc.).
...
```bash
sudo docker-compose -f stack-FASG.yml up --build -d
```
